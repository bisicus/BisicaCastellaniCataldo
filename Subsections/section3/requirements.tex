...
\item \textit{[G11]} The application allows the nearest shared vehicle

\item \textit{[G12]} The application can obtain a geolocalized position of the device its running on
