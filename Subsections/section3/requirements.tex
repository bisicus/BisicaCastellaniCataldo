...
\item \textit{[G6]} The application can automatically compute a personalized selection of travel times between appointments to choose from
                  ...
                  \begin{itemize}
                        ...
                        \item [R.6.3] The application must rank the suggestion according to their preference level, priority of an event and time required, and a cap on suggestions must be imposed
                        \item [R.6.4] The registered user can choose to filter out specific travel means
                        \item [R.6.5] Favourite travel means associated to an appointment must always show up
                        \item [R.6.6] In case two or more appointments overlap, an appointment with higher priority is considered automatically chosen and all the remaining ones are arranged according to their priority. Warnings must follow as expected
                        \item [R.6.7] The route can include intermediate destinations before the final, target one 
                        \item [R.6.8] When a shared vehicle is suggested the parking zone nearest to the destination must be always inserted among the intermediate destinations 
                        \item [R.6.9] The sytem must grant to know daily scheduled times for public transportation through its APIs
...
\item \textit{[G7]} User can choose a solution among the scheduled ones 
                   ...
                   \begin{itemize}
                        ...
                        \item [R.7.4] Buying a ticket must reroute the user to the corresponding payment service
