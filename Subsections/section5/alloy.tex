\subsection{The Model}
	...
	\subsubsection*{Signatures}
		...
		\vfill
		\includegraphics[width = \textwidth]{alloy/code/signature4}
		\vfill
		\includegraphics[width = \textwidth]{alloy/code/signature5}
		\bigskip
	...
	\subsubsection*{Facts}
		...
		\vfill
		\includegraphics[width = \textwidth]{alloy/code/fact3}
		\bigskip
	
	\subsubsection*{Predicates}
		\includegraphics[width = \textwidth]{alloy/code/predicates1}
		\vfill
		\includegraphics[width = \textwidth]{alloy/code/predicates2}
		\bigskip
...
\subsection{Generated World}
	...
	\begin{landscape}
		...
		\subsubsection{Ticket Purchase}
			\includegraphics[height= \textheight, width= 35cm, center]{alloy/generatedWorld/ticketPurchase}
	
		\subsubsection{Renting}
			\includegraphics[height = \textheight, width= 35cm, center]{alloy/generatedWorld/reserving}
		
		\subsubsection{Insert Appointment}
			\includegraphics[height = \textheight, width= 25cm, center]{alloy/generatedWorld/insertAppointment}
	\end{landscape}
