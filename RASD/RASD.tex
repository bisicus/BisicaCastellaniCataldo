...
%%% 1 - INTRODUCTION %%%
	...
	\section{Introduction}
		...
		\subsubsection{Goals}
			\input{Subsections/section1/goals.tex}
		...
		\subsection{Glossary}
			\input{Subsections/section1/glossary.tex}
		...
		\subsection{Document Structure}	
			\input{Subsections/section1/documentStructure.tex}
...
%%% 2 - OVERALL DESCRIPTION  %%%
	...
	\section{Overall Description}
		\input{Subsections/section2/overallDescription.tex}


%%% 3 - SPECIFIC REQUIREMENTS %%%
	\newpage
	\section{Specific Requirements}
		\input{Subsections/section3/specificRequirements.tex}

%%% 4 - SCENARIOS %%%
	\newpage
	\section{Scenarios}
		\input{Subsections/section4/scenarios}


%%% 5 - ALLOY %%%
	\newpage
	\section{Alloy modeling}
		\input{Subsections/section5/alloy.tex}
...
%%% 6 - APPENDIX %%%
	...
	\section{Appendix}
		...
		\subsection{Hours of work}
			\begin{description}
				\item[Bisica, Leonardo] around 65 hours of work;
				\item[Castellani, Alessandro] around 64 hours of work;
				\item[Cataldo, Michele] around 62 hours of work.
			\end{description}
